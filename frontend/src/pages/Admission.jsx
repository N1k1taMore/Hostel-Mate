...
function Admissionform() {
  ...
  const onSubmit = async (e) => {
    ...
    try {
      const body = { full_name, email, phone, addres, block_id, room }; // Corrected 'addres' to 'address'
      ...
      console.log("Error admitting resident:", err.message); // Improved error logging
    }
