...
const ComplaintForm = () => {
  ...
  return (
    <>
      <section className="bg-gray-100 py-12 text-gray-800 sm:py-15 h-full">
        <div className="bg-gray-100 mx-auto flex max-w-md flex-col rounded-lg lg:max-w-screen-xl lg:flex-row">
          <div className="max-w-2xl px-4 lg:pr-24">
            ...
            <p className="mb-10 text-md text-gray-600">
              Hostel Mate ensures a swift and confidential
            ...
            <div className="mb-5 flex font-medium">
              ...
              <div className="">
                ...
                <span className="font-normal text-gray-600">
                  ...
                  solutions, ensuring student concerns are promptly addressed
                  and resolved.
                </span>
              </div>
            </div>
          ...
          <div className="border border-gray-100 shadow-gray-500/20 mt-8 mb-12 max-w-md bg-white shadow-sm sm:rounded-lg sm:shadow-lg lg:mt-0">
  ...
  return (
    <>
      <div className="bg-gray-100 p-4 sm:p-8 md:p-10 h-screen">
        <h1 className="text-2xl font-bold mt-10 mb-8">Complaints</h1>
        {complaints.length === 0 ? (
